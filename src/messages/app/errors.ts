export const ERRORS = {
  ...
  AUTH_CHANGEMENT_MOT_DE_PASSE_RESERVE: 'errors.auth_changement_mot_de_passe_reserve',
  AUTH_MOT_DE_PASSE_ACTUEL_INVALIDE: 'errors.auth_mot_de_passe_actuel_invalide',
  AUTH_NOUVEAU_MOT_DE_PASSE_IDENTIQUE: 'errors.auth_nouveau_mot_de_passe_identique',
...
export const ERRORS_FR: Record<string, string> = {
  ...
  [ERRORS.AUTH_CHANGEMENT_MOT_DE_PASSE_RESERVE]: 'Changement de mot de passe reserve aux comptes admin',
  [ERRORS.AUTH_MOT_DE_PASSE_ACTUEL_INVALIDE]: 'Mot de passe actuel invalide',
  [ERRORS.AUTH_NOUVEAU_MOT_DE_PASSE_IDENTIQUE]: 'Le nouveau mot de passe doit etre different de l actuel',
...
export const ERRORS_EN: Record<string, string> = {
  ...
  [ERRORS.AUTH_CHANGEMENT_MOT_DE_PASSE_RESERVE]: 'Password change reserved to admin accounts',
  [ERRORS.AUTH_MOT_DE_PASSE_ACTUEL_INVALIDE]: 'Current password is invalid',
  [ERRORS.AUTH_NOUVEAU_MOT_DE_PASSE_IDENTIQUE]: 'The new password must be different from the current one',
