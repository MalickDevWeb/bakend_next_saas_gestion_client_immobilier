...
export const GET = executerAvecGestionErreurs(
  ...
  async (requete: NextRequest) => {
    ...
    const donnees = await conteneurDependances.controleurAdministrationAdmin.listerTravaux(
      jetonAcces,
      impersonation
    )
...
export const POST = executerAvecGestionErreurs(
  ...
  async (requete: NextRequest) => {
    ...
    const resultat = await conteneurDependances.controleurAdministrationAdmin.creerTravail(
      jetonAcces,
      impersonation,
      corps
    )
